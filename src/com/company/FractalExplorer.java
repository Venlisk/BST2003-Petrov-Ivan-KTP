...
public class FractalExplorer
{
    ...
    /**
     * Метод для отображения графического интерфейса
     */
    ...
    /**
     * Вспомогательный метод для рисования фрактала
     */
    ...
    /**
     * Внутренний класс, обрабатывающий события с дисплея
     */
    ...
    /**
     * Подкласс, отвечающий за вычислений значений цвета для одного фрактала
     */
    private class FractalWorker extends SwingWorker<Object, Object>
    {
        ...
        /**
         * Метод, вызывающийся в фоновом потоке
         */
        ...
        /**
         * Метод, вызывающийся когда фоновая задача завершена
         */
        protected void done() {
            for (int i = 0; i < computedRGBValues.length; i++) {
    ...
    /**
     * Метод, который позволяет взаимодействовать с интерфейсом только когда отрисовка завершена
     */
